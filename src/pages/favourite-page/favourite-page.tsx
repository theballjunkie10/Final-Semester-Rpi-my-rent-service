...
import { FavoritesCardList } from "../../components/FavoritesCardList/favorites-card-list";
...
function FavoritesPage({favoritesList}:FavoritesPageProps) {
    return (
        <div className="page">
      ...
      <main className="page__main page__main--favorites">
        <div className="page__favorites-container container">
          <section className="favorites">
            ...
            <FavoritesCardList favoritesList={favoritesList}/>
          </section>
        </div>
      </main>
